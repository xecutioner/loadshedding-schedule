Gem::Specification.new do |s|
  ...
  s.files       = ['bin/schedule', 'lib/downloader.rb', 'lib/schedule.rb', 'assets/schedule.pdf', 'lib/loadshedding.rb', 'lib/schedule_parser.rb', 'lib/group_scheduler.rb', 'lib/week_day.rb', 'lib/config_loader.rb', 'lib/interfacer.rb', 'lib/day_finder.rb', 'lib/timer.rb']
  s.homepage    =
